...
export default function About() {
  return (
    <>
      <Helmet>
        <title>About | Fuelflux</title>
        <meta
          name="description"
          content="Learn more about Fuelflux — a fuel price dashboard that helps you compare, track, and save on fuel costs with real-time visual analytics."
        />
      </Helmet>
